...
void main(void)
{
	...
	spheres[0].color = vec3(0.9, 0.0, 0.0);
	spheres[0].center = vec3(40, 20,40);
	spheres[0].radius = 12;
	
	spheres[1].color = vec3(0.0, 0.9 ,0.0);
	spheres[1].center = vec3(-35, 20, 40);
	spheres[1].radius = 11;

	spheres[2].color = vec3(0.0 ,0.0 ,0.9);
	spheres[2].center = vec3(0, 25, 30);
	spheres[2].radius = 10;
